...
Initial Setup
    ...
    Open Settings: Click extension icon → Settings button

    Select Location: Choose your JAKIM zone from dropdown (default: TRG01)

    Upload Adzan: Click "Choose File" and select your adzan audio

    Upload Doa (Optional): Enable "Play Doa after Adzan" and upload doa audio

    Adjust Volume: Set volume level (0-600%)
